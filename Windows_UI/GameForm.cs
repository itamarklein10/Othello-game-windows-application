...
namespace Windows_UI
{
    public class GameForm : Form
    {
        ...
        public void CheckIfGameOver()
        {
            ...
            if (m_GameLogic.m_User1PossibleMove.Count == k_NoPossibleMoves)
            {
                m_GameLogic.ScanAndUpdatePossiblMovesList(eCellValue.red, ref m_GameLogic.m_User2PossibleMove);
                if (m_GameLogic.m_User2PossibleMove.Count == k_NoPossibleMoves)
                {
                    FinishedGameMessage();
                }
            }
        ...
        public bool CheckIfAvailableMoves()
        {
            ...
            {
                m_GameLogic.ScanAndUpdatePossiblMovesList(eCellValue.yellow, ref m_GameLogic.m_User1PossibleMove);
                check = m_GameLogic.m_User1PossibleMove.Count > k_NoPossibleMoves;
            }
            else
            {
                m_GameLogic.ScanAndUpdatePossiblMovesList(eCellValue.red, ref m_GameLogic.m_User2PossibleMove);
                check = m_GameLogic.m_User2PossibleMove.Count > k_NoPossibleMoves;
            }
